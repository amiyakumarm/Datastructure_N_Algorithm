...
/**
 * 
 * @author amiyakumar.m Amazon is running a promotion in which customers receive
 *         prizes for purchasing a secret combination of fruits. The combination
 *         will change each day, and the team running the promotion wants to use
 *         a code list to make it easy to change the combination. The code list
 ...
 * 
 *         Consider the following secret code list: [[apple, apple], [banana,
 *         anything, banana]] Based on the above secret code list, a customer
 *         who made either of the following purchases would win the prize:
 *         orange, apple, apple, banana, orange, banana apple, apple, orange,
 *         orange, banana, apple, banana, banana
 * 
 *         Write an algorithm to output 1 if the customer is a winner else
 *         output 0.
 * 
 ...
 * 
 *         Note 'anything' in the codeList represents that any fruit can be
 *         ordered in place of 'anything' in the group. 'anything' has to be
 *         something, it cannot be "nothing." 'anything' must represent one and
 *         only one fruit. If secret code list is empty then it is assumed that
 ...
 *         is also maintained in the shoppingCart.
 * 
 *         Example 2:
 * 
 *         Input: codeList = [[apple, apple], [banana, anything, banana]]
 ...
 *         not following the group [apple, apple] in the codeList.
 * 
 *         Example 3:
 * 
 *         Input: codeList = [[apple, apple], [banana, anything, banana]]
